...
/*
ChangeLog
1.04/12/2004 Shearer Lu
	Use __attribute__((__packed__)) in all structure to pack them.
*/
#ifndef _CIFSPDU_H
#define _CIFSPDU_H
...
struct smb_hdr {
	...
	union {
		...
		}__attribute__((__packed__)) DosError;
	...
	union {
		struct {
			...
			__u32 Reserved; /* zero */
		}__attribute__((__packed__)) Sequence;
...
}__attribute__((__packed__)) NEGOTIATE_REQ;
...
typedef struct negotiate_rsp {
	...
	union {
		...
		}__attribute__((__packed__)) extended_response;
	} u;
}__attribute__((__packed__)) NEGOTIATE_RSP;
...
typedef union smb_com_session_setup_andx {
	struct {		/* request format */
		...
		/* STRING NativeOS */
		/* STRING NativeLanMan */
	}__attribute__((__packed__)) req;			/* NTLM request format (with extended security */
	...
	struct {		/* request format */
		...
		/* STRING NativeOS */
		/* STRING NativeLanMan */
	}__attribute__((__packed__)) req_no_secext;	/* NTLM request format (without extended security */
...
/*      unsigned char  * PrimaryDomain; */
	}__attribute__((__packed__)) resp;			/* NTLM response format (with or without extended security */
	...
	struct {		/* request format */
		...
		/* STRING NativeOS */
		/* STRING NativeLanMan */
	}__attribute__((__packed__)) old_req;		/* pre-NTLM (LANMAN2.1) request format */
...
/*	unsigned char * NativeLanMan; */
/*      unsigned char * PrimaryDomain; */
	}__attribute__((__packed__)) old_resp;		/* pre-NTLM (LANMAN2.1) response format */
}__attribute__((__packed__)) SESSION_SETUP_ANDX;
...
/* STRING Path    *//* \\server\share name */
	/* STRING Service */
}__attribute__((__packed__)) TCONX_REQ;
...
}__attribute__((__packed__)) TCONX_RSP;
...
typedef struct smb_com_logoff_andx_req {
	...
	__u16 AndXOffset;
	__u16 ByteCount;
}__attribute__((__packed__)) LOGOFF_ANDX_REQ;
...
typedef struct smb_com_logoff_andx_rsp {
	...
	__u16 AndXOffset;
	__u16 ByteCount;
}__attribute__((__packed__)) LOGOFF_ANDX_RSP;
...
}__attribute__((__packed__)) TREE_DISCONNECT;
...
typedef struct smb_com_close_req {
	...
	__u16 ByteCount;	/* 0 */
}__attribute__((__packed__)) CLOSE_REQ;

typedef struct smb_com_close_rsp {
	struct smb_hdr hdr;	/* wct = 0 */
	__u16 ByteCount;	/* bct = 0 */
}__attribute__((__packed__)) CLOSE_RSP;

typedef struct smb_com_findclose_req {
	struct smb_hdr hdr; /* wct = 1 */
	__u16 FileID;
	__u16 ByteCount;    /* 0 */
}__attribute__((__packed__)) FINDCLOSE_REQ;
...
typedef struct smb_com_open_req {	/* also handles create */
	...
	__u16 ByteCount;
	char fileName[1];
}__attribute__((__packed__)) OPEN_REQ;
...
typedef struct smb_com_open_rsp {
	...
	__u8 DirectoryFlag;
	__u16 ByteCount;	/* bct = 0 */
}__attribute__((__packed__)) OPEN_RSP;
...
typedef struct smb_com_write_req {
	...
	char Data[1];
}__attribute__((__packed__)) WRITE_REQ;
...
typedef struct smb_com_write_rsp {
	...
	__u32 Reserved;
	__u16 ByteCount;
}__attribute__((__packed__)) WRITE_RSP;
...
typedef struct smb_com_read_req {
	...
	__u32 OffsetHigh;
	__u16 ByteCount;
}__attribute__((__packed__)) READ_REQ;
...
typedef struct smb_com_read_rsp {
	...
	__u8 Pad;		/* BB check for whether padded to DWORD boundary and optimum performance here */
	char Data[1];
}__attribute__((__packed__)) READ_RSP;
...
typedef struct locking_andx_range {
	...
	__u32 LengthHigh;
	__u32 LengthLow;
}__attribute__((__packed__)) LOCKING_ANDX_RANGE;
...
}__attribute__((__packed__)) LOCK_REQ;
...
typedef struct smb_com_lock_rsp {
	...
	__u16 AndXOffset;
	__u16 ByteCount;
}__attribute__((__packed__)) LOCK_RSP;
...
}__attribute__((__packed__)) RENAME_REQ;
...
typedef struct smb_com_nt_rename_req {	/* A5 - also used for create hardlink */
	...
	/* followed by __u8 BufferFormat2 */
	/* followed by NewFileName */
}__attribute__((__packed__)) NT_RENAME_REQ;

typedef struct smb_com_rename_rsp {
	struct smb_hdr hdr;	/* wct = 0 */
	__u16 ByteCount;	/* bct = 0 */
}__attribute__((__packed__)) RENAME_RSP;
...
}__attribute__((__packed__)) DELETE_FILE_REQ;

typedef struct smb_com_delete_file_rsp {
	struct smb_hdr hdr;	/* wct = 0 */
	__u16 ByteCount;	/* bct = 0 */
}__attribute__((__packed__)) DELETE_FILE_RSP;
...
}__attribute__((__packed__)) DELETE_DIRECTORY_REQ;

typedef struct smb_com_delete_directory_rsp {
	struct smb_hdr hdr;	/* wct = 0 */
	__u16 ByteCount;	/* bct = 0 */
}__attribute__((__packed__)) DELETE_DIRECTORY_RSP;
...
typedef struct smb_com_create_directory_req {
	...
	__u8 BufferFormat;	/* 4 = ASCII */
	unsigned char DirName[1];
}__attribute__((__packed__)) CREATE_DIRECTORY_REQ;

typedef struct smb_com_create_directory_rsp {
	struct smb_hdr hdr;	/* wct = 0 */
	__u16 ByteCount;	/* bct = 0 */
}__attribute__((__packed__)) CREATE_DIRECTORY_RSP;
...
typedef struct smb_com_transaction_ioctl_req {
	...
	__u8 Pad[3];
	__u8 Data[1];
}__attribute__((__packed__)) TRANSACT_IOCTL_REQ;
...
typedef struct smb_com_transaction_ioctl_rsp {
	...
	__u16 ByteCount;
	__u8 Pad[3];
}__attribute__((__packed__)) TRANSACT_IOCTL_RSP;
...
typedef struct smb_com_transaction_change_notify_req {
	...
	__u8 Pad[3];
	__u8 Data[1];
}__attribute__((__packed__)) TRANSACT_CHANGE_NOTIFY_REQ;
...
}__attribute__((__packed__)) TRANSACTION2;
...
typedef struct smb_com_transaction2_qpi_req {
	...
	__u32 Reserved4;
	char FileName[1];
}__attribute__((__packed__)) TRANSACTION2_QPI_REQ;
...
typedef struct smb_com_transaction2_qpi_rsp {
	...
	__u16 ByteCount;
	__u16 Reserved2;	/* parameter word reserved - present for infolevels > 100 */
}__attribute__((__packed__)) TRANSACTION2_QPI_RSP;
...
typedef struct smb_com_transaction2_spi_req {
	...
	__u32 Reserved4;
	char FileName[1];
}__attribute__((__packed__)) TRANSACTION2_SPI_REQ;
...
typedef struct smb_com_transaction2_spi_rsp {
	...
	__u16 ByteCount;
	__u16 Reserved2;	/* parameter word reserved - present for infolevels > 100 */
}__attribute__((__packed__)) TRANSACTION2_SPI_RSP;
...
typedef struct smb_com_transaction2_ffirst_req {
	...
	char FileName[1];
}__attribute__((__packed__)) TRANSACTION2_FFIRST_REQ;
...
typedef struct smb_com_transaction2_ffirst_rsp {
	...
	__u8 Reserved1;		/* should be zero setup words following */
	__u16 ByteCount;
}__attribute__((__packed__)) TRANSACTION2_FFIRST_RSP;
...
}__attribute__((__packed__)) T2_FFIRST_RSP_PARMS;
...
}__attribute__((__packed__)) TRANSACTION2_FNEXT_REQ;
...
typedef struct smb_com_transaction2_fnext_rsp {
	...
	__u8 Reserved1;		/* should be zero setup words following */
	__u16 ByteCount;
}__attribute__((__packed__)) TRANSACTION2_FNEXT_RSP;
...
typedef struct smb_com_transaction2_fnext_rsp_parms {
	...
	__u16 EAErrorOffset;
	__u16 LastNameOffset;
}__attribute__((__packed__)) T2_FNEXT_RSP_PARMS;
...
typedef struct smb_com_transaction2_qfsi_req {
	...
	__u8 Pad;
	__u16 InformationLevel;
}__attribute__((__packed__)) TRANSACTION2_QFSI_REQ;
...
}__attribute__((__packed__)) TRANSACTION2_QFSI_RSP;
...
}__attribute__((__packed__)) TRANSACTION2_GET_DFS_REFER_REQ;
...
}__attribute__((__packed__)) REFERRAL3;
...
}__attribute__((__packed__)) TRANSACTION2_GET_DFS_REFER_RSP;
...
}__attribute__((__packed__)) FILE_SYSTEM_INFO;		/* size info, level 0x103 */

typedef struct {
	__u16 MajorVersionNumber;
	__u16 MinorVersionNumber;
	__u64 Capability;
}__attribute__((__packed__)) FILE_SYSTEM_UNIX_INFO;	/* Unix extensions info, level 0x200 */
...
}__attribute__((__packed__)) FILE_SYSTEM_DEVICE_INFO;	/* device info, level 0x104 */
...
}__attribute__((__packed__)) FILE_SYSTEM_ATTRIBUTE_INFO;
...
typedef struct {		/* data block encoding of response to level 263 QPathInfo */
	...
	__u32 FileNameLength;
	char FileName[1];
}__attribute__((__packed__)) FILE_ALL_INFO;		/* level 263 QPathInfo */
...
typedef struct {
	...
	__u64 Permissions;
	__u64 Nlinks;
}__attribute__((__packed__)) FILE_UNIX_BASIC_INFO;		/* level 512 QPathInfo */

typedef struct {
	char LinkDest[1];
}__attribute__((__packed__)) FILE_UNIX_LINK_INFO;		/* level 513 QPathInfo */
...
typedef struct {
	...
	__u64 Nlinks;
	char FileName[1];
}__attribute__((__packed__)) FILE_UNIX_INFO;
...
typedef struct {
	...
	__u32 Attributes;
	__u32 Pad;
}__attribute__((__packed__)) FILE_BASIC_INFO;		/* size info, level 0x101 */

struct file_allocation_info {
	__u64 AllocationSize;
}__attribute__((__packed__));		/* size info, level 0x103 */

struct file_end_of_file_info {
	__u64 FileSize;		/* offset to end of file */
}__attribute__((__packed__));	/* size info, level 0x104 */
...
typedef struct {
	...
	__u32 FileNameLength;
	char FileName[1];
}__attribute__((__packed__)) FILE_DIRECTORY_INFO;   /* level 257 FF response data area */
