...
#define __NR_enable_gpio              	(__NR_SYSCALL_BASE+257)
#define __NR_disable_gpio             	(__NR_SYSCALL_BASE+258)
#define __NR_own_beep             	(__NR_SYSCALL_BASE+259)
#define __NR_dump_gpreg             	(__NR_SYSCALL_BASE+260)
