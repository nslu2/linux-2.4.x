...
//super
asmlinkage void sys_enable_gpio(int pin)
{
	*IXP425_GPIO_GPOUTR |= 1 << pin;
}
asmlinkage void sys_disable_gpio(int pin)
{
	*IXP425_GPIO_GPOUTR &= ~(1 << pin);
}

asmlinkage void sys_own_beep()
{
	int i;
...
asmlinkage void sys_dump_gpreg(int pin)
{
	printk("IXP425_GPIO_GPOER is 0x%x\n",*IXP425_GPIO_GPOER);
	printk("IXP425_GPIO_GPOUTR is 0x%x\n",*IXP425_GPIO_GPOUTR);
	printk("IXP425_GPIO_GPIT1R is 0x%x\n",*IXP425_GPIO_GPIT1R);
	printk("IXP425_GPIO_GPIT2R is 0x%x\n",*IXP425_GPIO_GPIT2R);
}
