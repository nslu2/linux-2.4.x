...
char zft_src[] __initdata = "$Source: /home/cvsroot/NSLU2_V2/linux-2.4.x/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2004/09/28 06:06:06 $";
