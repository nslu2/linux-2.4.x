 ...
 *
 * $Id: unusual_devs.h,v 1.1.1.1 2004/09/28 06:06:35 sure Exp $
 *
...
/* 
 * Implementation of the Maxtor Corp. OneTouch feature.
 * Behaviour: when the button is pressed or released, a usb hotplug event will
 * be generated.
 */
...
UNUSUAL_DEV(  0x0D49, 0x5000, 0x0000, 0x9999,
               ...
               US_SC_SCSI, US_PR_BULK, mxo_ot_init,
               US_FL_SINGLE_LUN),
UNUSUAL_DEV(  0x0D49, 0x5010, 0x0000, 0x9999, 
		"Maxtor",
		"5000DV v01.00.00",
		US_SC_SCSI, US_PR_BULK, mxo_ot_init,
		US_FL_SINGLE_LUN),
