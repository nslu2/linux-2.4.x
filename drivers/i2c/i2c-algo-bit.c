...
/* $Id: i2c-algo-bit.c,v 1.1.1.1 2004/09/28 06:06:07 sure Exp $ */
...
static int i2c_outb(struct i2c_adapter *i2c_adap, char c)
{
...
#ifdef CONFIG_ARCH_SC806DVI
	struct ixp425_i2c_data *gpio_data= adap->data;
#endif
	...
	sdahi(adap);
#ifdef CONFIG_ARCH_SC806DVI
	gpio_line_config(gpio_data->sda_line, IXP425_GPIO_IN);
	for(i=0;i<10;i++) ;
#endif
	...
	gpio_line_config(gpio_data->sda_line, IXP425_GPIO_OUT);
	for(i=0;i<10;i++) ;
#endif
                                ...
                                struct i2c_msg *msg, int retries) 
{
	...
	if ( (flags & I2C_M_TEN)  ) { 
		...
		ret = try_address(i2c_adap, addr, retries);
		if (ret!=1) {
			printk("bit_doAddress: try_address error\n");
			return -EREMOTEIO;
		}
	}
	return 0;
