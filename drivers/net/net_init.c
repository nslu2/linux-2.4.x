...
//super add
extern void copy_from_flash(unsigned long from, void *to, ssize_t len);

#define NPE_IXP0_MAC_OFFSET 0x0003ffb0
char * get_ixp0_ethaddr(void)
{
  	copy_from_flash( NPE_IXP0_MAC_OFFSET,ixp0_mac,6);

	return ixp0_mac;
}
EXPORT_SYMBOL(get_ixp0_ethaddr);
//
